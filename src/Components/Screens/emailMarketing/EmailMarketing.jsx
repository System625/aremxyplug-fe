...
function EmailMarketing() {
  return (
    <>
      ...
      {/* grid1 Build a meaningful relationships with your customers.*/}
      <div
        className=" hidden md:grid  lg:gap-x-4 md:grid-cols-2 lg:grid-cols-5 md:gap-x-4    
    grid-cols-1 gap-y-4 
    lg:pr-32  px-6 sm:px-16 mt-[50px] lg:pl-12 md:mt-[80px] lg:mt-[100px]
     "
      ...
      {/* grid 2 Build a meaningful relationships with your customers.*/}
      <div
     ...
     "
      >
        ...
        <div
          className="h-[300px] md:h-[unset]  bg-contain bg-center bg-no-repeat "
          style={{
            backgroundImage:
              "url(./Images/email_marketing/customerRelationImage.png)",
          }}
      ...
      {/* grid1 Communicating with your customers*/}

      <div
        className="hidden md:grid  xl:gap-x-4  md:grid-cols-2 md:gap-x-4    
        grid-cols-1 gap-y-4 
     ...
     "
      ...
      {/* grid2 Communicating with your customers*/}

      <div
        className="md:hidden grid  lg:gap-x-4  md:grid-cols-2 md:gap-x-4    
        grid-cols-1 gap-y-4 
        lg:px-24 px-6 sm:px-16  mt-[50px]  md:mt-[80px] lg:mt-[100px] 
     ...
     "
      ...
      {/* grid1 Increase leads and product cost*/}
     ...
     "
      ...
      {/* grid1 Providing more value to your customers*/}
     ...
     "
      ...
      {/* grid2 Providing more value to your customers*/}
...
{/* Mobile View */}
     {/* Background image */}
     <div
            className="h-[350px] md:h-[unset]  bg-contain bg-center bg-no-repeat lg:mx-24 mx-6 sm:mx-16 "
            style={{
              backgroundImage:
                "url(./Images/email_marketing/keyFeaturesImage.png)",
            }}
          ></div>
<div
          className="grid md:hidden  xl:gap-x-4  md:grid-cols-2 md:gap-x-4    
        grid-cols-1 gap-y-4 
        lg:px-24 px-6 sm:px-16  mt-[10px]  md:mt-[30px] lg:mt-[50px] 
