  ...
  return (
    <>
        <div className='flex flex-col gap-[50px] md:flex-row md:gap-[0] md:justify-between md:items-center'>
            <div className="flex flex-col justify-between w-full h-[245.92px] md:h-[245.33px] md:w-[290px]">
                <h2 className="text-[20px] text-primary font-bold leading-[30px] w-[40%] md:text-[26.06px]">Content Marketing</h2>
            ...
            <div className="h-[265.33px] md:w-[288.75px] md:h-[266.55px]">
