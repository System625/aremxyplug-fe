...
const PaymentServiceHeader = () => {
  return (
    <div className='flex flex-col gap-[50px] mb-[80px] md:flex-row md:gap-[128.65px] md:items-center lg:gap-[233px]'>
      <div className="flex flex-col justify-between w-full h-[198px] md:w-[289.58px] md:h-[198.5px] lg:w-[500px] lg:h-[339px]">
        ...
        <p className="text-[12px] lg:text-[18px]">Thanks for visiting our payment services! We offer quick and secure payment processing to make sure your transactions go off without a hitch, using our user-friendly interface to receive money both locally and internationally.</p>
        <div>
          <Link to={`/sign-up`} className='bg-primary text-[10px] font-bold leading-[11.31px] text-white px-[35px] py-[12px] inline-block rounded-[7px] lg:px-[37px] lg:py-[15px] lg:text-[14px]'>Sign Up</Link>
        </div>
      </div>
