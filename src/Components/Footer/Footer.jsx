...
export const Footer = () => {
  ...
  return (
    <>
      ...
      {/* TABLET & DESKTOP VIEW */}
      <div className="hidden md:block bg-[#04177F] text-[#ffffff] h-[850px] lg:h-[900px] overflow-y-auto ">
        <img
        ...
        <div className="flex gap-[20%] h-[201px] w-[261px] pt-[15px] ml-[8%] lg:gap-[40%]">
        ...
        <div className="absolute top-[50%] right- flex gap-[90px] ml-[8%] lg:top-[100%] lg:gap-[120px]">
          <div className="flex flex-col h-[52px] gap-[15px] ">
            ...
            <div className="text-[11px] lg:text-[20px] lg:w-[356px]">Email us at: hello@aremxyplug.com</div>
          </div>
        ...
        <div className="absolute top-[60%] right-[45%] text-[9px] lg:text-[16px] lg:top-[125%] ">
          ©AremxyPlug 2023. All Rights Reserved.
        </div>
        <div className="absolute top-[62%] w-[702px] h-[30px] text-[7px] mx-[8%] lg:top-[130%] lg:text-[12px] lg:w-[1213px]">
          AremxyPlug is a business enterprise and telecommunication service
          provider company, not a bank. We offer telecom products, payments, and
          digital services. Banking services are provided by AremxyPlug’s
          payment partners and banks who are duly licensed by CBN, FCA, FDIC,
